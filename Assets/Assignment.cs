...
// Steps to fixing saving and loading
//
// 1. Get the ability to save a random line of text working [done]
// 2. Write the character values into the text file [done]
// 3. Load character values into screen using text file
// 4. reload the ui with 
